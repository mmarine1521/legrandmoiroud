...
void Affichage::AfficheArmees(state::State& state, sf::RenderWindow& window){
	...
	else if(Armee -> getIdJoueur()==2){
		armeeCongo.setColor(sf::Color(0, 255, 0));
	}
	else if(Armee -> getIdJoueur()==3){
...
std::string Affichage::PaysClic(sf::RenderWindow& window, sf::Event event){
	...
	if (event.type == sf::Event::MouseButtonPressed){
		...
		if(event.mouseButton.button ==sf::Mouse::Left){
			...
			else if(event.mouseButton.x>(179*fa_x) && event.mouseButton.x <(244*fa_x) && event.mouseButton.y >(241*fa_y) && event.mouseButton.y<(290*fa_y)){
				pays_clic = "Alberta";
			}
			else if(event.mouseButton.x>(239*fa_x) && event.mouseButton.x <(258*fa_x) && event.mouseButton.y >(374*fa_y) && event.mouseButton.y<(396*fa_y)){
				pays_clic = "Amérique Centrale";
			}
			else if(event.mouseButton.x>(271*fa_x) && event.mouseButton.x <(317*fa_x) && event.mouseButton.y >(317*fa_y) && event.mouseButton.y<(355*fa_y)){
				pays_clic = "Etats De L'Est";
			}
			else if(event.mouseButton.x>(395*fa_x) && event.mouseButton.x <(480*fa_x) && event.mouseButton.y >(81*fa_x) && event.mouseButton.y<(171*fa_y)){
				pays_clic = "Groenland";
			}
			else if(event.mouseButton.x>(166*fa_x) && event.mouseButton.x <(251*fa_x) && event.mouseButton.y >(200*fa_y) && event.mouseButton.y<(226*fa_y)){
				pays_clic = "Territoires Du Nord-Ouest";
			}
			else if(event.mouseButton.x>(257*fa_x) && event.mouseButton.x <(315*fa_x) && event.mouseButton.y >(268*fa_y) && event.mouseButton.y<(294*fa_y)){
				pays_clic = "Ontario";
			}
			else if(event.mouseButton.x>(335*fa_x) && event.mouseButton.x <(386*fa_x) && event.mouseButton.y >(256*fa_y) && event.mouseButton.y<(281*fa_y)){
				pays_clic = "Québec";
			}
			else if(event.mouseButton.x>(186*fa_x) && event.mouseButton.x <(244*fa_x) && event.mouseButton.y >(304*fa_y) && event.mouseButton.y<(341*fa_y)){
				pays_clic = "Etats De L'Ouest";
			}
			else if(event.mouseButton.x>(350*fa_x) && event.mouseButton.x <(379*fa_x) && event.mouseButton.y >(587*fa_y) && event.mouseButton.y<(627*fa_y)){
				pays_clic = "Argentine";
			}
			else if(event.mouseButton.x>(393*fa_x) && event.mouseButton.x <(441*fa_x) && event.mouseButton.y >(495*fa_y) && event.mouseButton.y<(555*fa_y)){
				pays_clic = "Brésil";
			}
			else if(event.mouseButton.x>(333*fa_x) && event.mouseButton.x <(382*fa_x) && event.mouseButton.y >(445*fa_y) && event.mouseButton.y<(460*fa_y)){
				pays_clic = "Pérou";
			}
			else if(event.mouseButton.x>(348*fa_x) && event.mouseButton.x <(373*fa_x) && event.mouseButton.y >(531*fa_y) && event.mouseButton.y<(560*fa_y)){
				pays_clic = "Vénézuela";
			}
			else if(event.mouseButton.x>(593*fa_x) && event.mouseButton.x <(646*fa_x) && event.mouseButton.y >(503*fa_y) && event.mouseButton.y<(563*fa_y)){
				pays_clic = "Congo";
			}
			else if(event.mouseButton.x>(652*fa_x) && event.mouseButton.x <(696*fa_x) && event.mouseButton.y >(442*fa_y) && event.mouseButton.y<(549*fa_y)){
				pays_clic = "Afrique De L'Est";
			}
			else if(event.mouseButton.x>(610*fa_x) && event.mouseButton.x <(669*fa_x) && event.mouseButton.y >(398*fa_y) && event.mouseButton.y<(440*fa_y)){
				pays_clic = "Egypte";
			}
			else if(event.mouseButton.x>(709*fa_x) && event.mouseButton.x <(729*fa_x) && event.mouseButton.y >(552*fa_y) && event.mouseButton.y<(602*fa_y)){
				pays_clic = "Madagascar";
			}
			else if(event.mouseButton.x>(511*fa_x) && event.mouseButton.x <(595*fa_x) && event.mouseButton.y >(392*fa_y) && event.mouseButton.y<(507*fa_y)){
				pays_clic = "Afrique Du Nord";
			}
			else if(event.mouseButton.x>(615*fa_x) && event.mouseButton.x <(660*fa_x) && event.mouseButton.y >(579*fa_y) && event.mouseButton.y<(616*fa_y)){
				pays_clic = "Afrique Du Sud";
			}
			else if(event.mouseButton.x>(986*fa_x) && event.mouseButton.x <(1045*fa_x) && event.mouseButton.y >(609*fa_y) && event.mouseButton.y<(688*fa_y)){
				pays_clic = "Australie Orientale";
			}
			else if(event.mouseButton.x>(857*fa_x) && event.mouseButton.x <(959*fa_x) && event.mouseButton.y >(499*fa_y) && event.mouseButton.y<(564*fa_y)){
				pays_clic = "Indonésie";
			}
			else if(event.mouseButton.x>(990*fa_x) && event.mouseButton.x <(1056*fa_x) && event.mouseButton.y >(522*fa_y) && event.mouseButton.y<(565*fa_y)){
				pays_clic = "Nouvelle-Guinée";
			}
			else if(event.mouseButton.x>(913*fa_x) && event.mouseButton.x <(985*fa_x) && event.mouseButton.y >(589*fa_y) && event.mouseButton.y<(674*fa_y)){
				pays_clic = "Australie Occidentale";
			}
			else if(event.mouseButton.x>(734*fa_x) && event.mouseButton.x <(808*fa_x) && event.mouseButton.y >(324*fa_y) && event.mouseButton.y<(364*fa_y)){
				pays_clic = "Afghanistan";
			}
			else if(event.mouseButton.x>(861*fa_x) && event.mouseButton.x <(940*fa_x) && event.mouseButton.y >(357*fa_y) && event.mouseButton.y<(402*fa_y)){
				pays_clic = "Chine";
			}
			else if(event.mouseButton.x>(776*fa_x) && event.mouseButton.x <(852*fa_x) && event.mouseButton.y >(393*fa_y) && event.mouseButton.y<(472*fa_y)){
				pays_clic = "Inde";
			}
			else if(event.mouseButton.x>(882*fa_x) && event.mouseButton.x <(957*fa_x) && event.mouseButton.y >(239*fa_y) && event.mouseButton.y<(297*fa_y)){
				pays_clic = "Tchita";
			}
			else if(event.mouseButton.x>(994*fa_x) && event.mouseButton.x <(1046*fa_x) && event.mouseButton.y >(345*fa_y) && event.mouseButton.y<(412*fa_y)){
				pays_clic = "Japon";
			}
			else if(event.mouseButton.x>(1044*fa_x) && event.mouseButton.x <(1134*fa_x) && event.mouseButton.y >(210*fa_y) && event.mouseButton.y<(310*fa_y)){
				pays_clic = "Kamtchatka";
			}
			else if(event.mouseButton.x>(979*fa_x) && event.mouseButton.x <(1034*fa_x) && event.mouseButton.y >(239*fa_y) && event.mouseButton.y<(329*fa_y)){
				pays_clic = "Kamtchatka";
			}
			else if(event.mouseButton.x>(686*fa_x) && event.mouseButton.x <(756*fa_x) && event.mouseButton.y >(371*fa_y) && event.mouseButton.y<(446*fa_y)){
				pays_clic = "Moyen-Orient";
			}
			else if(event.mouseButton.x>(896*fa_x) && event.mouseButton.x <(955*fa_x) && event.mouseButton.y >(312*fa_y) && event.mouseButton.y<(339*fa_y)){
				pays_clic = "Mongolie";
			}
			else if(event.mouseButton.x>(860*fa_x) && event.mouseButton.x <(890*fa_x) && event.mouseButton.y >(413*fa_y) && event.mouseButton.y<(492*fa_y)){
				pays_clic = "Siam";
			}
			else if(event.mouseButton.x>(809*fa_x) && event.mouseButton.x <(875*fa_x) && event.mouseButton.y >(198*fa_y) && event.mouseButton.y<(276*fa_y)){
				pays_clic = "Sibérie";
			}
			else if(event.mouseButton.x>(745*fa_x) && event.mouseButton.x <(790*fa_x) && event.mouseButton.y >(227*fa_y) && event.mouseButton.y<(303*fa_y)){
				pays_clic = "Oural";
			}
			else if(event.mouseButton.x>(790*fa_x) && event.mouseButton.x <(818*fa_x) && event.mouseButton.y >(293*fa_y) && event.mouseButton.y<(318*fa_y)){
				pays_clic = "Oural";
			}
			else if(event.mouseButton.x>(886*fa_x) && event.mouseButton.x <(1001*fa_x) && event.mouseButton.y >(159*fa_y) && event.mouseButton.y<(217*fa_y)){
				pays_clic = "Yakoutie";
			}
			else if(event.mouseButton.x>(513*fa_x) && event.mouseButton.x <(567*fa_x) && event.mouseButton.y >(253*fa_y) && event.mouseButton.y<(297*fa_y)){
				pays_clic = "Grande-Bretagne";
			}
			else if(event.mouseButton.x>(501*fa_x) && event.mouseButton.x <(571*fa_x) && event.mouseButton.y >(187*fa_y) && event.mouseButton.y<(230*fa_y)){
				pays_clic = "Islande";
			}
			else if(event.mouseButton.x>(590*fa_x) && event.mouseButton.x <(639*fa_x) && event.mouseButton.y >(280*fa_y) && event.mouseButton.y<(316*fa_y)){
				pays_clic = "Europe Du Nord";
			}
			else if(event.mouseButton.x>(589*fa_x) && event.mouseButton.x <(653*fa_x) && event.mouseButton.y >(205*fa_y) && event.mouseButton.y<(276*fa_y)){
				pays_clic = "Scandinavie";
			}
			else if(event.mouseButton.x>(596*fa_x) && event.mouseButton.x <(655*fa_x) && event.mouseButton.y >(323*fa_y) && event.mouseButton.y<(374*fa_y)){
				pays_clic = "Europe Du Sud";
			}
			else if(event.mouseButton.x>(658*fa_x) && event.mouseButton.x <(721*fa_x) && event.mouseButton.y >(214*fa_y) && event.mouseButton.y<(328*fa_y)){
				pays_clic = "Ukraine";
			}
			else if(event.mouseButton.x>(537*fa_x) && event.mouseButton.x <(583*fa_x) && event.mouseButton.y >(306*fa_y) && event.mouseButton.y<(372*fa_y)){
...
int Affichage::NombreClic(sf::RenderWindow& window, sf::Event event){
	...
	if (event.type == sf::Event::MouseButtonPressed){
		if(event.mouseButton.button ==sf::Mouse::Right){
			...
			else if(event.mouseButton.x>(1150*fa_x) && event.mouseButton.x <(1190*fa_x) && event.mouseButton.y >(150*fa_y) && event.mouseButton.y<(218*fa_y)){
				nombreArmees = 2;
			}
			else if(event.mouseButton.x>(1200*fa_x) && event.mouseButton.x <(1260*fa_x) && event.mouseButton.y >(150*fa_y) && event.mouseButton.y<(218*fa_y)){
				nombreArmees = 3;
			}
			else if(event.mouseButton.x>(1100*fa_x) && event.mouseButton.x <(1140*fa_x) && event.mouseButton.y >(220*fa_y) && event.mouseButton.y<(280*fa_y)){
				nombreArmees = 4;
			}
			else if(event.mouseButton.x>(1150*fa_x) && event.mouseButton.x <(1190*fa_x) && event.mouseButton.y >(220*fa_y) && event.mouseButton.y<(280*fa_y)){
				nombreArmees = 5;
			}
			else if(event.mouseButton.x>(1200*fa_x) && event.mouseButton.x <(1260*fa_x) && event.mouseButton.y >(220*fa_y) && event.mouseButton.y<(280*fa_y)){
				nombreArmees = 6;
			}
			else if(event.mouseButton.x>(1100*fa_x) && event.mouseButton.x <(1140*fa_x) && event.mouseButton.y >(290*fa_y) && event.mouseButton.y<(350*fa_y)){
				nombreArmees = 7;
			}
			else if(event.mouseButton.x>(1150*fa_x) && event.mouseButton.x <(1190*fa_x) && event.mouseButton.y >(290*fa_y) && event.mouseButton.y<(350*fa_y)){
				nombreArmees = 8;
			}
			else if(event.mouseButton.x>(1200*fa_x) && event.mouseButton.x <(1260*fa_x) && event.mouseButton.y >(290*fa_y) && event.mouseButton.y<(350*fa_y)){
				nombreArmees = 9;
			}
		}
	}
